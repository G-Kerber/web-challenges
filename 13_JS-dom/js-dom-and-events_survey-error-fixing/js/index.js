...
const nextButton = document.querySelector('[data-js="next-button"]'); //switch id throw data-js
...
firstChoiceButton.addEventListener("click", () => {
  ...
  console.log("Selected first choice"); //log is fail
});
...
secondChoiceButton.addEventListener("click", () => {
  ...
  secondChoiceButton.classList.add("active-choice"); //switch remove to add
