...
console.log("exercise-1_", age, contact);
...
console.log("exercise-2_", first, second, restOfList);
/*
EXERCISE 3
...
console.log("exercise-4_", result);
...
console.log("exercise-5_", allFruits);
