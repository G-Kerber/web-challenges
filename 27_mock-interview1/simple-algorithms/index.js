...
function maxOfTwoNumbers(num1, num2) {
  // TODO:
  // 1. erstelle eine if schleife
  // 2. vergleiche die beiden parameter
  // 3. zurückgeben des größeren Parameters

  if (num1 < num2) {return maximum = num2}
  else if (num1 > num2) {return maximum = num1}; 
  else return maximum = "ES gibt kein Maximum. Beide Zahlen sind gleich gross.";
}
...
function sumNumbers(numbers) {
  // TODO:
  // 1. Nutzen der javaScript-Funktion reduce
  // 2. Rueckgabe der Quersumme
